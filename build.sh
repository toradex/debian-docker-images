...
IMAGE_QT5_WAYLAND_CLIENT=${REPOSITORY}/${ARCH}-debian-qt5-wayland-client:buster
...
"build")
    ...
    docker build -f qt5-wayland-client/Dockerfile -t ${IMAGE_QT5_WAYLAND_CLIENT} qt5-wayland-client/
	;;
"deploy")
	docker push ${IMAGE_BASE}
	docker push ${IMAGE_WESTON}
	docker push ${IMAGE_WAYLAND_CLIENT}
	docker push ${IMAGE_QT5_WAYLAND_CLIENT}
	;;
*)
